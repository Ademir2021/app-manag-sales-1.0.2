...
export function NavBar() {
    ...
    return (
        <>
            <nav className="navbar navbar-expand-lg navbar-dark" style={{ background: 'whitesmoke', border: '1px solid rgb(237,237,237)'}} aria-label="Offcanvas navbar large">
                        ...
                        <div className="offcanvas-body">
                            ...
                            <ul className="navbar-nav justify-content-end flex-grow-1 pe-3">
                                ...
                                <li className="nav-item">
                                    {checksUserLogged() === privilegeShopping ? <a className="nav-link" aria-current="page" href="/dashboardefault"><b>Painel</b></a> :
            ...
            <i style={{ color: 'black', fontSize: '12px', margin:'16px'}}>{Globais.calendar}</i>
        </>
    )
}